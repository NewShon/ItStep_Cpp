...
void Test::my_test() const{
	...
	std::cout << "\n\nMIN = " << mv.get_min() << std::endl;
	std::cout << "MAX = " << mv.get_max() << std::endl;

	std::cout << "\nAll_vectors = " << MyVector::all_vectors << std::endl;
	std::cout << "Surviving vectors = " << MyVector::surviving_vectors << std::endl;
